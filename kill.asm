...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f8:	0f b6 80 98 0a 00 00 	movzbl 0xa98(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 555:	75 09                	jne    560 <printf+0x101>
          s = "(null)";
 557:	c7 45 f4 4b 08 00 00 	movl   $0x84b,-0xc(%ebp)
        while(*s != 0){
...
000006f4 <morecore>:
 ...
 713:	50                   	push   %eax
 714:	e8 3e fc ff ff       	call   357 <sbrk>
 ...
 74d:	a1 b4 0a 00 00       	mov    0xab4,%eax
 752:	c9                   	leave  
 753:	c3                   	ret    
...
00000754 <malloc>:
 ...
 777:	c7 45 f0 ac 0a 00 00 	movl   $0xaac,-0x10(%ebp)
 77e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 781:	a3 b4 0a 00 00       	mov    %eax,0xab4
 786:	a1 b4 0a 00 00       	mov    0xab4,%eax
 78b:	a3 ac 0a 00 00       	mov    %eax,0xaac
 790:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 797:	00 00 00 
 ...
 7ed:	a3 b4 0a 00 00       	mov    %eax,0xab4
 7f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7f5:	83 c0 08             	add    $0x8,%eax
 7f8:	eb 3b                	jmp    835 <malloc+0xe1>
 7fa:	a1 b4 0a 00 00       	mov    0xab4,%eax
