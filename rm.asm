...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 73 08 00 	movl   $0x873,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 420:	0f b6 80 d8 0a 00 00 	movzbl 0xad8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 57d:	75 09                	jne    588 <printf+0x101>
          s = "(null)";
 57f:	c7 45 f4 8c 08 00 00 	movl   $0x88c,-0xc(%ebp)
        while(*s != 0){
...
0000063a <free>:
 ...
 649:	a1 f4 0a 00 00       	mov    0xaf4,%eax
 ...
 714:	a3 f4 0a 00 00       	mov    %eax,0xaf4
 719:	90                   	nop
 71a:	c9                   	leave  
 71b:	c3                   	ret    
...
0000071c <morecore>:
 ...
 775:	a1 f4 0a 00 00       	mov    0xaf4,%eax
 77a:	c9                   	leave  
 77b:	c3                   	ret    
...
0000077c <malloc>:
 ...
 791:	a1 f4 0a 00 00       	mov    0xaf4,%eax
 796:	89 45 f0             	mov    %eax,-0x10(%ebp)
 799:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 79d:	75 23                	jne    7c2 <malloc+0x46>
 79f:	c7 45 f0 ec 0a 00 00 	movl   $0xaec,-0x10(%ebp)
 7a6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a9:	a3 f4 0a 00 00       	mov    %eax,0xaf4
 7ae:	a1 f4 0a 00 00       	mov    0xaf4,%eax
 7b3:	a3 ec 0a 00 00       	mov    %eax,0xaec
 7b8:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 7bf:	00 00 00 
