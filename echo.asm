...
main(int argc, char *argv[])
{
  ...
  1f:	b8 3c 08 00 00       	mov    $0x83c,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 3e 08 00 00       	mov    $0x83e,%eax
  ...
  45:	c7 44 24 04 40 08 00 	movl   $0x840,0x4(%esp)
  4c:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fd:	0f b6 80 90 0a 00 00 	movzbl 0xa90(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 55a:	75 09                	jne    565 <printf+0x101>
          s = "(null)";
 55c:	c7 45 f4 45 08 00 00 	movl   $0x845,-0xc(%ebp)
        while(*s != 0){
...
000006f9 <morecore>:
 ...
 718:	50                   	push   %eax
 719:	e8 3e fc ff ff       	call   35c <sbrk>
 ...
 752:	a1 ac 0a 00 00       	mov    0xaac,%eax
 757:	c9                   	leave  
 758:	c3                   	ret    
...
00000759 <malloc>:
 ...
 76e:	a1 ac 0a 00 00       	mov    0xaac,%eax
 773:	89 45 f0             	mov    %eax,-0x10(%ebp)
 776:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 77a:	75 23                	jne    79f <malloc+0x46>
 77c:	c7 45 f0 a4 0a 00 00 	movl   $0xaa4,-0x10(%ebp)
 783:	8b 45 f0             	mov    -0x10(%ebp),%eax
 786:	a3 ac 0a 00 00       	mov    %eax,0xaac
 78b:	a1 ac 0a 00 00       	mov    0xaac,%eax
 790:	a3 a4 0a 00 00       	mov    %eax,0xaa4
 795:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 79c:	00 00 00 
 ...
 7f2:	a3 ac 0a 00 00       	mov    %eax,0xaac
 7f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7fa:	83 c0 08             	add    $0x8,%eax
 7fd:	eb 3b                	jmp    83a <malloc+0xe1>
 7ff:	a1 ac 0a 00 00       	mov    0xaac,%eax
