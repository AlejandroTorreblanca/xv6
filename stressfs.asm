...
main(int argc, char *argv[])
{
  ...
  91:	c7 44 24 04 96 09 00 	movl   $0x996,0x4(%esp)
  98:	00 
...
//    printf(fd, "%d\n", i);
 ...
 125:	e8 19 03 00 00       	call   443 <close>
  ...
  printf(1, "read\n");
 12a:	c7 44 24 04 a0 09 00 	movl   $0x9a0,0x4(%esp)
 131:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 544:	0f b6 80 f4 0b 00 00 	movzbl 0xbf4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6a1:	75 09                	jne    6ac <printf+0x101>
          s = "(null)";
 6a3:	c7 45 f4 a6 09 00 00 	movl   $0x9a6,-0xc(%ebp)
        while(*s != 0){
...
0000075e <free>:
 ...
 76d:	a1 10 0c 00 00       	mov    0xc10,%eax
 ...
 838:	a3 10 0c 00 00       	mov    %eax,0xc10
 83d:	90                   	nop
 83e:	c9                   	leave  
 83f:	c3                   	ret    
...
00000840 <morecore>:
 ...
 85f:	50                   	push   %eax
 860:	e8 3e fc ff ff       	call   4a3 <sbrk>
 ...
 899:	a1 10 0c 00 00       	mov    0xc10,%eax
 89e:	c9                   	leave  
 89f:	c3                   	ret    
...
000008a0 <malloc>:
 ...
 8c3:	c7 45 f0 08 0c 00 00 	movl   $0xc08,-0x10(%ebp)
 8ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8cd:	a3 10 0c 00 00       	mov    %eax,0xc10
 8d2:	a1 10 0c 00 00       	mov    0xc10,%eax
 8d7:	a3 08 0c 00 00       	mov    %eax,0xc08
 8dc:	c7 05 0c 0c 00 00 00 	movl   $0x0,0xc0c
 8e3:	00 00 00 
