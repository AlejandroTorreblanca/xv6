...
main(void)
{
  ...
  8d:	c7 44 24 04 fd 08 00 	movl   $0x8fd,0x4(%esp)
  94:	00 
  ...
  ab:	75 2d                	jne    da <main+0xda>
      exec("sh", argv);
  ad:	c7 44 24 04 7c 0b 00 	movl   $0xb7c,0x4(%esp)
  b4:	00 
  b5:	c7 04 24 df 08 00 00 	movl   $0x8df,(%esp)
  bc:	e8 ee 02 00 00       	call   3af <exec>
      printf(1, "init: exec sh failed\n");
  c1:	c7 44 24 04 10 09 00 	movl   $0x910,0x4(%esp)
  c8:	00 
  ...
  da:	eb 14                	jmp    f0 <main+0xf0>
      printf(1, "zombie!\n");
  dc:	c7 44 24 04 26 09 00 	movl   $0x926,0x4(%esp)
  e3:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a0:	0f b6 80 84 0b 00 00 	movzbl 0xb84(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5fd:	75 09                	jne    608 <printf+0x101>
          s = "(null)";
 5ff:	c7 45 f4 2f 09 00 00 	movl   $0x92f,-0xc(%ebp)
        while(*s != 0){
...
000006ba <free>:
 ...
 6c9:	a1 a0 0b 00 00       	mov    0xba0,%eax
...
0000079c <morecore>:
 ...
 7bb:	50                   	push   %eax
 7bc:	e8 3e fc ff ff       	call   3ff <sbrk>
...
000007fc <malloc>:
 ...
 811:	a1 a0 0b 00 00       	mov    0xba0,%eax
 816:	89 45 f0             	mov    %eax,-0x10(%ebp)
 819:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 81d:	75 23                	jne    842 <malloc+0x46>
 81f:	c7 45 f0 98 0b 00 00 	movl   $0xb98,-0x10(%ebp)
 826:	8b 45 f0             	mov    -0x10(%ebp),%eax
 829:	a3 a0 0b 00 00       	mov    %eax,0xba0
 82e:	a1 a0 0b 00 00       	mov    0xba0,%eax
 833:	a3 98 0b 00 00       	mov    %eax,0xb98
 838:	c7 05 9c 0b 00 00 00 	movl   $0x0,0xb9c
 83f:	00 00 00 
