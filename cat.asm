...
cat(int fd)
{
  ...
  28:	c7 44 24 04 0b 09 00 	movl   $0x90b,0x4(%esp)
  2f:	00 
...
cat(int fd)
{
  ...
  6b:	c7 44 24 04 1d 09 00 	movl   $0x91d,0x4(%esp)
  72:	00 
...
main(int argc, char *argv[])
{
  ...
  f3:	c7 44 24 04 2e 09 00 	movl   $0x92e,0x4(%esp)
  fa:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4cc:	0f b6 80 b0 0b 00 00 	movzbl 0xbb0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 629:	75 09                	jne    634 <printf+0x101>
          s = "(null)";
 62b:	c7 45 f4 43 09 00 00 	movl   $0x943,-0xc(%ebp)
        while(*s != 0){
...
000006e6 <free>:
 ...
 6f5:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 ...
 7c0:	a3 e8 0b 00 00       	mov    %eax,0xbe8
 7c5:	90                   	nop
 7c6:	c9                   	leave  
 7c7:	c3                   	ret    
...
000007c8 <morecore>:
 ...
 7e7:	50                   	push   %eax
 7e8:	e8 3e fc ff ff       	call   42b <sbrk>
 ...
 821:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 826:	c9                   	leave  
 827:	c3                   	ret    
...
00000828 <malloc>:
 ...
 83d:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 842:	89 45 f0             	mov    %eax,-0x10(%ebp)
 845:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 849:	75 23                	jne    86e <malloc+0x46>
 84b:	c7 45 f0 e0 0b 00 00 	movl   $0xbe0,-0x10(%ebp)
 852:	8b 45 f0             	mov    -0x10(%ebp),%eax
 855:	a3 e8 0b 00 00       	mov    %eax,0xbe8
 85a:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 85f:	a3 e0 0b 00 00       	mov    %eax,0xbe0
 864:	c7 05 e4 0b 00 00 00 	movl   $0x0,0xbe4
 86b:	00 00 00 
