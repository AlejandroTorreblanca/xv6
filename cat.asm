...
cat(int fd)
{
  ...
  25:	68 bf 08 00 00       	push   $0x8bf
  2a:	6a 01                	push   $0x1
  2c:	e8 d8 04 00 00       	call   509 <printf>
...
cat(int fd)
{
  ...
  63:	68 d1 08 00 00       	push   $0x8d1
  68:	6a 01                	push   $0x1
  6a:	e8 9a 04 00 00       	call   509 <printf>
...
main(int argc, char *argv[])
{
  ...
  ea:	50                   	push   %eax
  eb:	68 e2 08 00 00       	push   $0x8e2
  f0:	6a 01                	push   $0x1
  f2:	e8 12 04 00 00       	call   509 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a5:	0f b6 80 6c 0b 00 00 	movzbl 0xb6c(%eax),%eax
...
free(void *ap)
{
 ...
 6a9:	a1 88 0b 00 00       	mov    0xb88,%eax
...
free(void *ap)
{
 ...
 774:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 779:	90                   	nop
 77a:	c9                   	leave  
 77b:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 79b:	50                   	push   %eax
 79c:	e8 69 fc ff ff       	call   40a <sbrk>
 ...
 7d2:	83 c4 10             	add    $0x10,%esp
  return freep;
 7d5:	a1 88 0b 00 00       	mov    0xb88,%eax
}
 7da:	c9                   	leave  
 7db:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 875:	a3 88 0b 00 00       	mov    %eax,0xb88
      return (void*)(p + 1);
 ...
 880:	eb 3b                	jmp    8bd <malloc+0xe1>
    ...
    if(p == freep)
 882:	a1 88 0b 00 00       	mov    0xb88,%eax
