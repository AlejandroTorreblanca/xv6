...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     391:	c7 04 24 2d 15 00 00 	movl   $0x152d,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3af:	e8 32 10 00 00       	call   13e6 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ed:	e8 f4 0f 00 00       	call   13e6 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     458:	e8 89 0f 00 00       	call   13e6 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4a8:	e8 39 0f 00 00       	call   13e6 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4f8:	e8 e9 0e 00 00       	call   13e6 <malloc>
     ...
     542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55b:	c7 04 24 44 1a 00 00 	movl   $0x1a44,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     605:	c7 04 24 44 1a 00 00 	movl   $0x1a44,(%esp)
     ...
     622:	c7 04 24 4a 1a 00 00 	movl   $0x1a4a,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b75:	74 0c                	je     b83 <parseexec+0xb1>
      panic("syntax");
     b77:	c7 04 24 42 15 00 00 	movl   $0x1542,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba8:	7e 0c                	jle    bb6 <parseexec+0xe4>
      panic("too many args");
     baa:	c7 04 24 91 15 00 00 	movl   $0x1591,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd2:	c7 44 24 08 9f 15 00 	movl   $0x159f,0x8(%esp)
     bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3c:	8b 04 85 a4 15 00 00 	mov    0x15a4(,%eax,4),%eax
     c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    108a:	0f b6 80 52 1a 00 00 	movzbl 0x1a52(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11e7:	75 09                	jne    11f2 <printf+0x101>
          s = "(null)";
    11e9:	c7 45 f4 bc 15 00 00 	movl   $0x15bc,-0xc(%ebp)
        while(*s != 0){
...
000012a4 <free>:
    ...
    12b3:	a1 ec 1a 00 00       	mov    0x1aec,%eax
    ...
    137e:	a3 ec 1a 00 00       	mov    %eax,0x1aec
    1383:	90                   	nop
    1384:	c9                   	leave  
    1385:	c3                   	ret    
...
00001386 <morecore>:
    ...
    1389:	83 ec 18             	sub    $0x18,%esp
    138c:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    1393:	77 07                	ja     139c <morecore+0x16>
    1395:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
    139c:	8b 45 08             	mov    0x8(%ebp),%eax
    139f:	c1 e0 03             	shl    $0x3,%eax
    13a2:	83 ec 0c             	sub    $0xc,%esp
    13a5:	50                   	push   %eax
    13a6:	e8 3e fc ff ff       	call   fe9 <sbrk>
    13ab:	83 c4 10             	add    $0x10,%esp
    13ae:	89 45 f4             	mov    %eax,-0xc(%ebp)
    13b1:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    13b5:	75 07                	jne    13be <morecore+0x38>
    13b7:	b8 00 00 00 00       	mov    $0x0,%eax
    13bc:	eb 26                	jmp    13e4 <morecore+0x5e>
    13be:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13c1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    13d6:	50                   	push   %eax
    13d7:	e8 c8 fe ff ff       	call   12a4 <free>
    13dc:	83 c4 10             	add    $0x10,%esp
    13df:	a1 ec 1a 00 00       	mov    0x1aec,%eax
    13e4:	c9                   	leave  
    13e5:	c3                   	ret    
...
000013e6 <malloc>:
    ...
    13ef:	83 c0 07             	add    $0x7,%eax
    13f2:	c1 e8 03             	shr    $0x3,%eax
    13f5:	83 c0 01             	add    $0x1,%eax
    13f8:	89 45 ec             	mov    %eax,-0x14(%ebp)
    13fb:	a1 ec 1a 00 00       	mov    0x1aec,%eax
    1400:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1403:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1407:	75 23                	jne    142c <malloc+0x46>
    1409:	c7 45 f0 e4 1a 00 00 	movl   $0x1ae4,-0x10(%ebp)
    1410:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1413:	a3 ec 1a 00 00       	mov    %eax,0x1aec
    1418:	a1 ec 1a 00 00       	mov    0x1aec,%eax
    141d:	a3 e4 1a 00 00       	mov    %eax,0x1ae4
    1422:	c7 05 e8 1a 00 00 00 	movl   $0x0,0x1ae8
    1429:	00 00 00 
    ...
    143d:	72 4d                	jb     148c <malloc+0xa6>
    143f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1442:	8b 40 04             	mov    0x4(%eax),%eax
    1445:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1448:	75 0c                	jne    1456 <malloc+0x70>
    144a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    144d:	8b 10                	mov    (%eax),%edx
    144f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1452:	89 10                	mov    %edx,(%eax)
    1454:	eb 26                	jmp    147c <malloc+0x96>
    1456:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1459:	8b 40 04             	mov    0x4(%eax),%eax
    145c:	2b 45 ec             	sub    -0x14(%ebp),%eax
    145f:	89 c2                	mov    %eax,%edx
    1461:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1464:	89 50 04             	mov    %edx,0x4(%eax)
    1467:	8b 45 f4             	mov    -0xc(%ebp),%eax
    146a:	8b 40 04             	mov    0x4(%eax),%eax
    146d:	c1 e0 03             	shl    $0x3,%eax
    1470:	01 45 f4             	add    %eax,-0xc(%ebp)
    1473:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1476:	8b 55 ec             	mov    -0x14(%ebp),%edx
    1479:	89 50 04             	mov    %edx,0x4(%eax)
    147c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    147f:	a3 ec 1a 00 00       	mov    %eax,0x1aec
    1484:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1487:	83 c0 08             	add    $0x8,%eax
    148a:	eb 3b                	jmp    14c7 <malloc+0xe1>
    148c:	a1 ec 1a 00 00       	mov    0x1aec,%eax
    1491:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    1494:	75 1e                	jne    14b4 <malloc+0xce>
    1496:	83 ec 0c             	sub    $0xc,%esp
    1499:	ff 75 ec             	pushl  -0x14(%ebp)
    149c:	e8 e5 fe ff ff       	call   1386 <morecore>
    14a1:	83 c4 10             	add    $0x10,%esp
    14a4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    14a7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14ab:	75 07                	jne    14b4 <malloc+0xce>
    14ad:	b8 00 00 00 00       	mov    $0x0,%eax
    14b2:	eb 13                	jmp    14c7 <malloc+0xe1>
    ...
    14c2:	e9 6d ff ff ff       	jmp    1434 <malloc+0x4e>
    14c7:	c9                   	leave  
    14c8:	c3                   	ret    
