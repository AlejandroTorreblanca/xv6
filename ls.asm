...
fmtname(char *path)
{
  ...
  61:	c7 04 24 28 0e 00 00 	movl   $0xe28,(%esp)
  ...
  8c:	05 28 0e 00 00       	add    $0xe28,%eax
  ...
  return buf;
  a5:	b8 28 0e 00 00       	mov    $0xe28,%eax
}
...
ls(char *path)
{
  ...
  df:	c7 44 24 04 2b 0b 00 	movl   $0xb2b,0x4(%esp)
  e6:	00 
 ...
 118:	c7 44 24 04 3f 0b 00 	movl   $0xb3f,0x4(%esp)
 11f:	00 
 ...
 183:	c7 44 24 04 53 0b 00 	movl   $0xb53,0x4(%esp)
 18a:	00 
 ...
 1b1:	c7 44 24 04 60 0b 00 	movl   $0xb60,0x4(%esp)
 1b8:	00 
 ...
 269:	c7 44 24 04 3f 0b 00 	movl   $0xb3f,0x4(%esp)
 270:	00 
 ...
 2b3:	c7 44 24 04 53 0b 00 	movl   $0xb53,0x4(%esp)
 2ba:	00 
...
main(int argc, char *argv[])
{
 ...
 311:	7f 11                	jg     324 <main+0x20>
    ls(".");
 313:	c7 04 24 73 0b 00 00 	movl   $0xb73,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ec:	0f b6 80 14 0e 00 00 	movzbl 0xe14(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 849:	75 09                	jne    854 <printf+0x101>
          s = "(null)";
 84b:	c7 45 f4 75 0b 00 00 	movl   $0xb75,-0xc(%ebp)
        while(*s != 0){
...
00000906 <free>:
 ...
 915:	a1 40 0e 00 00       	mov    0xe40,%eax
 ...
 9e0:	a3 40 0e 00 00       	mov    %eax,0xe40
 9e5:	90                   	nop
 9e6:	c9                   	leave  
 9e7:	c3                   	ret    
...
000009e8 <morecore>:
 ...
 9ee:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
 9f5:	77 07                	ja     9fe <morecore+0x16>
 9f7:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
 9fe:	8b 45 08             	mov    0x8(%ebp),%eax
 a01:	c1 e0 03             	shl    $0x3,%eax
 a04:	83 ec 0c             	sub    $0xc,%esp
 a07:	50                   	push   %eax
 a08:	e8 3e fc ff ff       	call   64b <sbrk>
 a0d:	83 c4 10             	add    $0x10,%esp
 a10:	89 45 f4             	mov    %eax,-0xc(%ebp)
 a13:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 a17:	75 07                	jne    a20 <morecore+0x38>
 a19:	b8 00 00 00 00       	mov    $0x0,%eax
 a1e:	eb 26                	jmp    a46 <morecore+0x5e>
 ...
 a38:	50                   	push   %eax
 a39:	e8 c8 fe ff ff       	call   906 <free>
 a3e:	83 c4 10             	add    $0x10,%esp
 a41:	a1 40 0e 00 00       	mov    0xe40,%eax
 a46:	c9                   	leave  
 a47:	c3                   	ret    
...
00000a48 <malloc>:
 ...
 a51:	83 c0 07             	add    $0x7,%eax
 a54:	c1 e8 03             	shr    $0x3,%eax
 a57:	83 c0 01             	add    $0x1,%eax
 a5a:	89 45 ec             	mov    %eax,-0x14(%ebp)
 a5d:	a1 40 0e 00 00       	mov    0xe40,%eax
 a62:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a65:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a69:	75 23                	jne    a8e <malloc+0x46>
 a6b:	c7 45 f0 38 0e 00 00 	movl   $0xe38,-0x10(%ebp)
 a72:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a75:	a3 40 0e 00 00       	mov    %eax,0xe40
 a7a:	a1 40 0e 00 00       	mov    0xe40,%eax
 a7f:	a3 38 0e 00 00       	mov    %eax,0xe38
 a84:	c7 05 3c 0e 00 00 00 	movl   $0x0,0xe3c
 a8b:	00 00 00 
 ...
 ad2:	01 45 f4             	add    %eax,-0xc(%ebp)
 ad5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ad8:	8b 55 ec             	mov    -0x14(%ebp),%edx
 adb:	89 50 04             	mov    %edx,0x4(%eax)
 ade:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ae1:	a3 40 0e 00 00       	mov    %eax,0xe40
 ae6:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ae9:	83 c0 08             	add    $0x8,%eax
 aec:	eb 3b                	jmp    b29 <malloc+0xe1>
 aee:	a1 40 0e 00 00       	mov    0xe40,%eax
 af3:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 af6:	75 1e                	jne    b16 <malloc+0xce>
 af8:	83 ec 0c             	sub    $0xc,%esp
 afb:	ff 75 ec             	pushl  -0x14(%ebp)
 afe:	e8 e5 fe ff ff       	call   9e8 <morecore>
 b03:	83 c4 10             	add    $0x10,%esp
 b06:	89 45 f4             	mov    %eax,-0xc(%ebp)
 b09:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b0d:	75 07                	jne    b16 <malloc+0xce>
 b0f:	b8 00 00 00 00       	mov    $0x0,%eax
 b14:	eb 13                	jmp    b29 <malloc+0xe1>
 ...
 b24:	e9 6d ff ff ff       	jmp    a96 <malloc+0x4e>
 b29:	c9                   	leave  
 b2a:	c3                   	ret    
